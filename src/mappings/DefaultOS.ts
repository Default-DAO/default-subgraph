...
export function handleModuleInstalled(event: ModuleInstalled): void {
  ...
  if (moduleKeyCode == "EPC") EpochTemplate.create(module)
  else if (moduleKeyCode == "MBR") MembersTemplate.create(module)
  else if (moduleKeyCode == "MNG") MiningTemplate.create(module)
  else if (moduleKeyCode == "PAY") PeerRewardsTemplate.create(module)
  else if (moduleKeyCode == "TSY") TreasuryTemplate.create(module)
